...
del TB-7000_ADB.7z
plugins\7z.exe a TB-7000_ADB.7z ..\* -x!installer -x!.git -x!images\Thumbs.db -x!images\driver.png -x!images\header.png -x!images\siragon.xmp -x!images\toaster.fw.png -x!*\dpinst.properties -x!*\inf.properties -x!*\installer.properties -x!*\notice.txt -x!.gitignore -x!.gitattributes -x!.tx
